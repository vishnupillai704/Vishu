...
7)db.addresses.find({borough:"bronx"}).skip(5)
...
11)db.addresses.finf({$and:[{cuisine:{$ne:"American "}},{"grades.score":{$gt:70}},{"address.coord":{$lt:-65.754168}}]})
...
18)db.addresses.find({borough:{$in:["Staten Island","Queens","Bronxor Brooklyn"]}},{restaurant_id:1,name:1,borough:1,cuisine:1})
19)db.addresses.find({borough:{$nin:["Staten Island","Queens","Bronxor Brooklyn"]}},{restaurant_id:1,name:1,borough:1,cuisine:1})
20)db.addresses.find({"grades.score":{$lt:10}},{restaurant_id:1,name:1,borough:1,cuisine:1})
21)db.addresses.find({cuisine:{$nin:["American ","Chinese"]}},{restaurant_id:1,name:1,borough:1,cuisine:1})
22)db.addresses.find({"grades.grade":"A","grades.date":ISODate("2014-08-11T00:00:00Z"),"grades.score":11},{restaurant_id:1,name:1,grades:1})
23)db.addresses.find({"grades.1.grade":"A","grades.1.score":9,"grades.1.date":ISODate("2014-08-1100:00:00Z")},{restaurant_id:1,name:1,grades:1})
...
29)db.addresses.find({"address.cord":{$type:1}})
